...
class UtilityController extends Controller
{
    ...
    public function uploadFile(Request $request): JsonResponse
    {
        $validated = $request->validate([
            'file' => 'required|file|mimes:jpeg,png,jpg,gif,webp,svg,pdf,doc,docx,xls,xlsx,csv,txt,zip,mp4,mov,webm,m4v,ogg|max:40960',
        ]);
        $file = $validated['file'];
    ...
    public function uploadMultiple(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'files.*' => 'required|file|mimes:jpeg,png,jpg,gif,webp,svg,pdf,doc,docx,xls,xlsx,csv,txt,zip,mp4,mov,webm,m4v,ogg|max:40960',
        ]);
